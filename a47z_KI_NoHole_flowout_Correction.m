function a47z_KI_NoHole_flowout_Correction

'a47z_KI_NoHole_flowout_Correction.m'
...
concentration=qf_load('KI_NoHole_flowout_concentration.nii.gz');
...
qf_save(T2_revised,strcat('Corrected-T2_KI_NoHole_flowout_Correction.nii.gz'))
a40_plot_correction(x,y,xw,yw,xg,yg,modelfun,beta,concentration,para,'KI-NoHole',seg,wm,gm)
                        
fslqf('fslcpgeom ../struct.nii.gz Corrected-T2_KI_NoHole_flowout_Correction.nii.gz')
fslqf('fslswapdim Corrected-T2_KI_NoHole_flowout_Correction.nii.gz -x y z Corrected-T2_KI_NoHole_flowout_Correction.nii.gz')
