function aa0_process_statistics_varbin(durationFrame,ra,fitmethod,bin)
...
[x,y]= a_comp_fit(concentration,bin,ra,mask,para);
[xw,yw]= a_comp_fit(concentration,bin,ra,(mask>0)&(seg==wm)&(WMfromMNI_BW==1),para);
[xg,yg]= a_comp_fit(concentration,bin,ra,(mask>0)&(seg==gm)&(GMfromMNI_BW==1),para);
