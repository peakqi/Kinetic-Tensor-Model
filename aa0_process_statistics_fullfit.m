function aa0_process_statistics_fullfit(durationFrame,ra,fitmethod,bin)
...
[x,y]= a_comp_fit_fullfit(concentration,bin,ra,mask,para);
[xw,yw]= a_comp_fit_fullfit(concentration,bin,ra,(mask>0)&(seg==wm)&(WMfromMNI_BW==1),para);
[xg,yg]= a_comp_fit_fullfit(concentration,bin,ra,(mask>0)&(seg==gm)&(GMfromMNI_BW==1),para);
...
aa0_plot_correction_fullfit(x,y,xw,yw,xg,yg,modelfun,beta,concentration,para,'KI-NoHole',seg,wm,gm,durationFrame,fitmethod)
...
qf_save(T2_revised,strcat('dF_',num2str(durationFrame),'Corrected-T2.nii.gz'))
aa0_plot_correction_fullfit(x,y,xw,yw,xg,yg,modelfun,beta,concentration,para,'KI-withHole',seg,wm,gm,durationFrame,fitmethod)
...
qf_save(T2_revised,strcat('dF_',num2str(durationFrame),'Corrected-T2.nii.gz'))
aa0_plot_correction_fullfit(x,y,xw,yw,xg,yg,modelfun,beta,concentration,para,'KT-withHole',seg,wm,gm,durationFrame,fitmethod)
